...
class authentication {
    ...
    public function checkForAuthentication()
    {
    	...
    	{
    		$this->postAuthenticate( PHPAppRegistry::getObject('db')->sanitizeData( $_POST['ecomf_auth_user'] ), md5( $_POST['ecomf_auth_pass'] ) );
    	}
	     //echo $this->userID;
    }
    ...
    private function sessionAuthenticate( $uid )
    {
    	...
    	PHPAppRegistry::getObject('db')->executeQuery( $sql );
    	if( PHPAppRegistry::getObject('db')->numRows() == 1 )
    	{
    		$userData = PHPAppRegistry::getObject('db')->getRows();
